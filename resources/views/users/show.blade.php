...
<div class="max-w-3xl mx-auto px-6 py-8">
    ...
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-100 flex items-center gap-2">
            <i class="fa-solid fa-user text-blue-600"></i> User Details
        </h2>
    ...
    <div class="bg-white dark:bg-gray-800 shadow-lg rounded-2xl p-8 border border-gray-200 dark:border-gray-700">
        <div class="space-y-6">
            ...
            {{-- Name --}}
            <div>
                <h3 class="text-sm font-semibold text-gray-600 dark:text-gray-300 uppercase mb-1">Name</h3>
                <p class="text-lg font-medium text-gray-900 dark:text-gray-100">{{ $user->name }}</p>
            </div>

            {{-- Email --}}
            <div>
                <h3 class="text-sm font-semibold text-gray-600 dark:text-gray-300 uppercase mb-1">Email</h3>
                <p class="text-lg font-medium text-gray-900 dark:text-gray-100">{{ $user->email }}</p>
            </div>

            {{-- Roles --}}
            <div>
                <h3 class="text-sm font-semibold text-gray-600 dark:text-gray-300 uppercase mb-2">Assigned Roles</h3>
                ...
                @else
                    <p class="text-gray-500 dark:text-gray-400 text-sm">No roles assigned.</p>
                @endif
            </div>
        </div>
    </div>
